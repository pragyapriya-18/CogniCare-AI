...
export default function FocusChallengePage() {
  ...
  // Read difficulty from URL param first, then fall back to the AI's
  // last prediction stored in localStorage (same pattern as Memory Match).
  React.useEffect(() => {
  ...
  React.useEffect(() => {
    ...
    const accuracy = Math.round(
      (score / (currentSettings.rounds * currentSettings.points)) * 100
    );
  ...
  }, [finished, score, currentSettings.rounds, currentSettings.points]);
